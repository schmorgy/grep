...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = x86_64-apple-darwin21.3.0
host_triplet = x86_64-apple-darwin21.3.0
subdir = .
...
ACLOCAL = ${SHELL} '/Users/craig/Downloads/grep-3.7/build-aux/missing' aclocal-1.16
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
AR = ar
ARFLAGS = cr
AUTOCONF = ${SHELL} '/Users/craig/Downloads/grep-3.7/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/craig/Downloads/grep-3.7/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/craig/Downloads/grep-3.7/build-aux/missing' automake-1.16
AWK = awk
BITSIZEOF_PTRDIFF_T = 
...
COLORIZE_SOURCE = colorize-posix.c
...
GL_GNULIB_ACCEPT = IN_GREP_GNULIB_TESTS
GL_GNULIB_ACCEPT4 = 0
GL_GNULIB_ACCESS = 0
GL_GNULIB_ALIGNED_ALLOC = 0
GL_GNULIB_ALPHASORT = 0
GL_GNULIB_ATOLL = 0
GL_GNULIB_BIND = IN_GREP_GNULIB_TESTS
GL_GNULIB_BTOWC = 1
...
GL_GNULIB_CONNECT = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_ENVIRON = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_FDOPEN = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_FTELL = 0
GL_GNULIB_FTELLO = 0
GL_GNULIB_FTRUNCATE = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_GETTIMEOFDAY = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_INET_PTON = IN_GREP_GNULIB_TESTS
GL_GNULIB_IOCTL = IN_GREP_GNULIB_TESTS
GL_GNULIB_ISATTY = 1
GL_GNULIB_ISBLANK = 1
...
GL_GNULIB_LINK = 0
GL_GNULIB_LINKAT = 0
GL_GNULIB_LISTEN = IN_GREP_GNULIB_TESTS
GL_GNULIB_LOCALECONV = 1
GL_GNULIB_LOCALENAME = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_MKTIME = 0
GL_GNULIB_NANOSLEEP = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_PCLOSE = 0
GL_GNULIB_PERROR = IN_GREP_GNULIB_TESTS
GL_GNULIB_PIPE = 1
GL_GNULIB_PIPE2 = 0
GL_GNULIB_POPEN = 0
...
GL_GNULIB_PTHREAD_SIGMASK = IN_GREP_GNULIB_TESTS
GL_GNULIB_PTHREAD_SPIN = 0
GL_GNULIB_PTHREAD_THREAD = IN_GREP_GNULIB_TESTS
GL_GNULIB_PTHREAD_TSS = 0
GL_GNULIB_PTSNAME = 0
GL_GNULIB_PTSNAME_R = 0
GL_GNULIB_PUTC = 1
GL_GNULIB_PUTCHAR = 1
GL_GNULIB_PUTENV = IN_GREP_GNULIB_TESTS
GL_GNULIB_PUTS = 1
GL_GNULIB_PWRITE = 0
GL_GNULIB_QSORT_R = 0
GL_GNULIB_RAISE = 1
...
GL_GNULIB_SELECT = IN_GREP_GNULIB_TESTS
GL_GNULIB_SEND = 0
GL_GNULIB_SENDTO = 0
GL_GNULIB_SETENV = IN_GREP_GNULIB_TESTS
GL_GNULIB_SETHOSTNAME = 0
GL_GNULIB_SETLOCALE = IN_GREP_GNULIB_TESTS
GL_GNULIB_SETLOCALE_NULL = 1
GL_GNULIB_SETSOCKOPT = IN_GREP_GNULIB_TESTS
GL_GNULIB_SHUTDOWN = 0
GL_GNULIB_SIGABBREV_NP = 0
GL_GNULIB_SIGACTION = IN_GREP_GNULIB_TESTS
GL_GNULIB_SIGDESCR_NP = 0
GL_GNULIB_SIGNAL_H_SIGPIPE = 0
GL_GNULIB_SIGPROCMASK = IN_GREP_GNULIB_TESTS
GL_GNULIB_SLEEP = IN_GREP_GNULIB_TESTS
GL_GNULIB_SNPRINTF = IN_GREP_GNULIB_TESTS
GL_GNULIB_SOCKET = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_STRERROR_R = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_SYMLINK = IN_GREP_GNULIB_TESTS
...
GL_GNULIB_UNSETENV = IN_GREP_GNULIB_TESTS
GL_GNULIB_USLEEP = 0
...
LDFLAGS = 
LIBCSTACK = 
LIBGREPUTILS_LIBDEPS =  -liconv
LIBGREPUTILS_LTLIBDEPS =  -liconv
LIBICONV = -liconv
...
LTLIBSIGSEGV = 
LTLIBTHREAD = 
MAKEINFO = ${SHELL} '/Users/craig/Downloads/grep-3.7/build-aux/missing' makeinfo
...
abs_aux_dir = /Users/craig/Downloads/grep-3.7/build-aux
abs_builddir = /Users/craig/Downloads/grep-3.7
abs_srcdir = /Users/craig/Downloads/grep-3.7
abs_top_builddir = /Users/craig/Downloads/grep-3.7
abs_top_srcdir = /Users/craig/Downloads/grep-3.7
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  chdir-long.o error.o fnmatch.o fopen.o fpending.o free.o fstatat.o fts.o getopt.o getopt1.o lstat.o mempcpy.o memrchr.o nl_langinfo.o obstack.o open.o openat.o rawmemchr.o reallocarray.o regex.o setlocale-lock.o stat.o strerror.o strerror-override.o strstr.o wcwidth.o wmempcpy.o
gl_LTLIBOBJS =  chdir-long.lo error.lo fnmatch.lo fopen.lo fpending.lo free.lo fstatat.lo fts.lo getopt.lo getopt1.lo lstat.lo mempcpy.lo memrchr.lo nl_langinfo.lo obstack.lo open.lo openat.lo rawmemchr.lo reallocarray.lo regex.lo setlocale-lock.lo stat.lo strerror.lo strerror-override.lo strstr.lo wcwidth.lo wmempcpy.lo
gltests_LIBOBJS =  asnprintf.o ioctl.o nanosleep.o perror.o printf-args.o printf-parse.o putenv.o setlocale.o strerror_r.o symlink.o vasnprintf.o
gltests_LTLIBOBJS =  asnprintf.lo ioctl.lo nanosleep.lo perror.lo printf-args.lo printf-parse.lo putenv.lo setlocale.lo strerror_r.lo symlink.lo vasnprintf.lo
...
install_sh = ${SHELL} /Users/craig/Downloads/grep-3.7/build-aux/install-sh
